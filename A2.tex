...
G.Start.capacity = 0 \;
G.end.capacity = 0 \;
G.addEdge(start, T$_{1}$, w=0)\;
G.addEdge(start, O$_{1}$, w=0)\;
\For{i: 1 ... n}{
\If{i \textless n}{
G.addEdge(T$_{i}$, T$_{i+1}$, w=0)\;
G.addEdge(O$_{i}$, O$_{i+1}$, w=0)\;
G.T$_{i}$.capacity = T$_{i}$ * -1 \#initialize the vertex with the negative of their weight \;
G.O$_{i}$.capacity = O$_{i}$ * -1 \;
G.addEdge(T$_{i}$, O$_{i+1}$, w=3)\;
G.addEdge(O$_{i}$, T$_{i+1}$, w=3)\;
}
\Else{
G.addEdge(T$_{i}$, end, w=0)\;
G.addEdge(O$_{i}$, end, w=0)\;}
}
...
\Else{
Income += end.capacity + w(end, end.parent)\;
S.add(0, end)\;
