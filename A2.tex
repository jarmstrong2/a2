...
If the result is greater than 1 then we have marbling cycle (cycle
 ...
 cycle.\\
\emph{Proof}\\
\textbf{Claim}\\ Given ratios r$_{ij}$ representing all possible exchanges x$_{i}$ and x$_{j}$ from n set of friends, the algorithm will return True if a beneficial marbling cycle exits and False otherwise.\\
\textbf{Base Case}\\
